...
export function renderDashboard() {
  ...
  if (!store.user) {
    ...
    emptyState.innerHTML = `
                <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; padding: 2.5rem 1rem; text-align:center;">
                    ...
                    <p style="color:var(--text-light); max-width: 420px; line-height: 1.6; margin-bottom: 2rem;">Không gian lưu trữ hoàn toàn riêng tư. Bạn cần phải đăng nhập tài khoản Google để mã hóa và truy cập vào kho truyện của riêng mình.</p>
  ...
  if (store.data.length === 0) {
    ...
    emptyState.innerHTML = `
                ...
                <h3 style="margin-bottom:0.5rem;font-weight:500;">Kho truyện trống trơn</h3>
  ...
  if (store.viewMode === "list") {
    ...
    const savedCols =
      (store.settings && store.settings.gridCols) ||
  ...
  const pagedSeries =
    seriesList.length > DASHBOARD_PAGE_SIZE
      ? seriesList.slice(
  ...
  if (!paginationEl) {
    ...
    paginationEl.style.cssText =
      "display:flex;justify-content:center;align-items:center;gap:0.75rem;padding:1.5rem 0 0.5rem;";
  ...
  window.app._dashboardImgObserver = new IntersectionObserver(
    (entries, observer) => {
  ...
  pagedSeries.forEach((sg) => {
    const hasCover =
      sg.latestVolume.coverUrl && sg.latestVolume.coverUrl.trim() !== "";
    ...
    const coverHtml = hasCover
      ? `<img data-src="${sg.latestVolume.coverUrl}" src="${BLANK}" alt="${safeTitle}" class="lazy-cover" style="width:100%;height:100%;object-fit:cover;" onerror="if(this.src&&!this.src.startsWith('data:')){this.outerHTML='<div style=&quot;width:100%;height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:0.5rem;color:#86efac;font-size:0.85rem;font-weight:500;background:#0f3d21;text-align:center;padding:1rem;&quot;><svg width=&quot;40&quot; height=&quot;40&quot; viewBox=&quot;0 0 24 24&quot; fill=&quot;none&quot; stroke=&quot;currentColor&quot; stroke-width=&quot;2&quot; style=&quot;opacity:0.5&quot;><rect x=&quot;3&quot; y=&quot;3&quot; width=&quot;18&quot; height=&quot;18&quot; rx=&quot;2&quot; ry=&quot;2&quot;></rect><circle cx=&quot;8.5&quot; cy=&quot;8.5&quot; r=&quot;1.5&quot;></circle><polyline points=&quot;21 15 16 10 5 21&quot;></polyline></svg><span>Không có bìa</span></div>'}">`
...
export function toggleCustomDropdown(id) {
  // Close others first
  document
    .querySelectorAll(".custom-select-container .user-dropdown")
    .forEach((d) => {
...
export function renderSeriesDetail(seriesName, page = 1) {
  ...
  const uniqueVolNumbers = new Set(
    allVolumes.map((v) => Number(v.volume) || 0),
  );
  ...
  if (
    ...
    store.seriesMetadata[seriesName] &&
    store.seriesMetadata[seriesName].total_volumes > 0
  ) {
  ...
  if (
    ...
    store.userSeriesSettings[seriesName].target_volumes > 0
  ) {
    total = Math.max(
      owned,
      store.userSeriesSettings[seriesName].target_volumes,
    );
  }
  ...
  list.className =
    store.detailViewMode === "list" ? "detail-grid list-view" : "detail-grid";

  const icon = document.getElementById("icon-detail-view-mode");
  if (icon)
    icon.setAttribute(
      "data-feather",
      store.detailViewMode === "list" ? "grid" : "list",
    );
  ...
  pagedVolumes.forEach((v) => {
    ...
    const coverHtml = hasCover
      ? `<img src="${v.coverUrl}" alt="Cover" loading="lazy" style="width:100%;height:100%;object-fit:cover;" onerror="if(this.src&&!this.src.startsWith('data:')){this.outerHTML='<div style=&quot;width:100%;height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:0.5rem;color:#86efac;font-size:0.75rem;font-weight:500;background:#0f3d21;text-align:center;padding:0.75rem;&quot;><svg width=&quot;32&quot; height=&quot;32&quot; viewBox=&quot;0 0 24 24&quot; fill=&quot;none&quot; stroke=&quot;currentColor&quot; stroke-width=&quot;2&quot; style=&quot;opacity:0.5&quot;><rect x=&quot;3&quot; y=&quot;3&quot; width=&quot;18&quot; height=&quot;18&quot; rx=&quot;2&quot; ry=&quot;2&quot;></rect><circle cx=&quot;8.5&quot; cy=&quot;8.5&quot; r=&quot;1.5&quot;></circle><polyline points=&quot;21 15 16 10 5 21&quot;></polyline></svg><span>Không có bìa</span></div>'}">`
...
export async function editSeriesTarget(seriesName) {
  if (!store.user) {
    window.app.showToast(
      "Bạn cần đăng nhập để thiết lập mục tiêu cá nhân!",
      "error",
    );
    return;
  }
...
export function getEditionBadge(title) {
  if (!title) return "";
  const t = title.toLowerCase();
  if (t.includes("sưu tầm") || t.includes("collector"))
    return `<span class="edition-badge badge-collector">Sưu Tầm</span>`;
  if (t.includes("giới hạn") || t.includes("limited"))
    return `<span class="edition-badge badge-limited">Giới Hạn</span>`;
  if (t.includes("đặc biệt") || t.includes("special"))
    return `<span class="edition-badge badge-special">Đặc Biệt</span>`;
  return "";
}
