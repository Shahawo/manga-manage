...
export function applySettings() {
    // Cột Grid
    document.documentElement.style.setProperty('--grid-cols', store.settings.gridCols);
...
export function showSettings() {
    ...
    if (overlay) {
        ...
        const cols = store.settings.gridCols || localStorage.getItem('gridCols') || '6';
        ...
        const fontSize = store.settings.fontSize || localStorage.getItem('fontSize') || 'normal';
